        ...
        if data != None and data !=[]:
            for key in data.keys():
                if 'event' and 'building' and 'type' in data[key]:
                    if   (data[key]['event'] == 'READY' or data[key]['event'] == 'OFFLINE') and data[key]['building'] == 'N' and data[key]['type'] == 'D':
                        GradDorm3_sensor_list[0]['COUNT'] = GradDorm3_sensor_list[0]['COUNT'] + 1
                    elif (data[key]['event'] == 'READY' or data[key]['event'] == 'OFFLINE') and data[key]['building'] == 'N' and data[key]['type'] == 'W':
                        GradDorm3_sensor_list[1]['COUNT'] = GradDorm3_sensor_list[1]['COUNT'] + 1
                    elif (data[key]['event'] == 'READY' or data[key]['event'] == 'OFFLINE') and data[key]['building'] == 'S' and data[key]['type'] == 'D':
                        GradDorm3_sensor_list[2]['COUNT'] = GradDorm3_sensor_list[2]['COUNT'] + 1
                    elif (data[key]['event'] == 'READY' or data[key]['event'] == 'OFFLINE') and data[key]['building'] == 'S' and data[key]['type'] == 'W':
